...
var _bigardone$phoenix_and_elm_subscription_form$Main$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_elm_lang$html$Html$text('Hello, Elm'));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _bigardone$phoenix_and_elm_subscription_form$Main$main !== 'undefined') {
    _bigardone$phoenix_and_elm_subscription_form$Main$main(Elm['Main'], 'Main', {"types":{"unions":{},"aliases":{},"message":"msg"},"versions":{"elm":"0.18.0"}});
}
